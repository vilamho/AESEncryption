...
unsigned char s_box[256] =
{
    ...
    0x60, 0x81, 0x4F, 0xDC, 0x22, 0x2A, 0x90, 0x88, 0x46, 0xEE, 0xB8, 0x14, 0xDE, 0x5E, 0x0B, 0xD8,
    0xE0, 0x32, 0x3A, 0x0A, 0x49, 0x06, 0x24, 0x5C, 0xC2, 0xD3, 0xAC, 0x62, 0x91, 0x95, 0xE4, 0x79,
    0xE7, 0xC8, 0x37, 0x6D, 0x8D, 0xD5, 0x4E, 0xA9, 0x6C, 0x56, 0xF4, 0xEA, 0x65, 0x7A, 0xAE, 0x08,
    0xBA, 0x78, 0x25, 0x2E, 0x1C, 0xA6, 0xB4, 0xC6, 0xE8, 0xDD, 0x74, 0x1F, 0x4B, 0xBD, 0x8B, 0x8A,
    0x70, 0x3E, 0xB5, 0x66, 0x48, 0x03, 0xF6, 0x0E, 0x61, 0x35, 0x57, 0xB9, 0x86, 0xC1, 0x1D, 0x9E,
    0xE1, 0xF8, 0x98, 0x11, 0x69, 0xD9, 0x8E, 0x94, 0x9B, 0x1E, 0x87, 0xE9, 0xCE, 0x55, 0x28, 0xDF,
    0x8C, 0xA1, 0x89, 0x0D, 0xBF, 0xE6, 0x42, 0x68, 0x41, 0x99, 0x2D, 0x0F, 0x80, 0x54, 0xB8, 0x16
};
unsigned char mul2[] =
{
    ...
    0xc0, 0xc2, 0xc4, 0xc6, 0xc8, 0xca, 0xcc, 0xce, 0xf0, 0xd2, 0xd4, 0xd6, 0xd8, 0xda, 0xdc, 0xde,
...
void KeyExpansion(unsigned char* inputKey,unsigned char* expandedKeys)
{
    ...
    int rconIteration = 1; //RCon Iteration begines at 1
    ...
    while(bytesGenerated<176)
    {
        ...
        //XOR temp with [bytesGenerates -16], and store in expanedKeys;
...
void MixColumns(unsigned char* state)
{
    ...
    tmp[6] = (unsigned char) (state[4]^mul2[state[5]]^mul3[state[6]]^state[7]);
...
void AES_Encrypt(unsigned char* key, unsigned char* state )

{
    ...
    AddRoundKey(key, expandedKeys); //whitening/AddRoundKey
...
{
   unsigned char message[] = "a message that will be encrypted with AES";
   unsigned char key[16] =
    ...
    {
        if(i>= ofiginalLen) paddedMessage[i] = 0;
